  ...
  return (
    <div ref={menuRef} style={{ position: 'relative', flexShrink: 0 }}>
      <button onClick={() => setMenuOpen(v => !v)} style={{
        ...
        background: menuOpen ? 'rgba(139,92,246,0.1)' : 'var(--p-surface)',
        border: `1px solid ${menuOpen ? 'rgba(139,92,246,0.3)' : 'var(--p-border)'}`,
        ...
        <span style={{ fontFamily: '"Space Grotesk",sans-serif', fontSize: 12, fontWeight: 600, color: 'var(--ds-title-section)' }}>
